...
* Project Manager, University of Washington Libraries	
* Manage project, co-author institutional application profiles in Wikidata, lead batch projects for entities described in the Labor Archives of Washington (EAD-to-Wikidata) and electronic theses and dissertations and related entities (MARC-to-Wikidata), maintain project page and documentation including automated lists of entities created and project Dashboard
...
* Publish suite of local BIBFRAME application profiles using the Sinopia Linked Data Editor to facilitate upload of local BIBFRAME data to Sinopia
...
#### iSchool Student Capstone Project Support
* 2016 - 2018
...
* Rare books cataloging
* Rare cartographic materials cataloging
* Archival processing
* Encoded Archival Description
* Visual materials description
...
* RDF Ontologies (LRM/RDA/RDF, BIBFRAME, Dublin Core, VRA)
* DPLA MAP
* RML
* SPARQL
* SHeX
